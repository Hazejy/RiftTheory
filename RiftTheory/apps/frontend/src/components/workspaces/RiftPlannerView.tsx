...
export default function RiftPlannerView() {
    ...
    const [championSize, setChampionSize] = createSignal(initial.championSize);
    ...
    const openWorkspace = (document: PlannerDocument) => {
        ...
        setChampionSize(
            Math.max(24, Math.min(64, document.championSize ?? 38)),
        );
        setHistory([]);
        setTool({ kind: "select" });
    };
                ...
                <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_300px]">
                    ...
                    <aside class="grid content-start gap-4">
                        <RiftPlannerRoster
                            ...
                            championSize={championSize()}
                            setChampionSize={setChampionSize}
                        />
