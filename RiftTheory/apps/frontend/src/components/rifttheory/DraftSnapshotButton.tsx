    ...
    async function save() {
        ...
        try {
            const missing = await downloadDraftSnapshot({
                ...
                blueWinrate:
                    allyDraftAnalysis()?.totalRating === undefined
                        ? undefined
                        : ratingToWinrate(allyDraftAnalysis()!.totalRating!),
                redWinrate:
                    opponentDraftAnalysis()?.totalRating === undefined
                        ? undefined
                        : ratingToWinrate(
                              opponentDraftAnalysis()!.totalRating!,
                          ),
