...
export default function SuggestionEvidenceBadges(props: {
    ...
    onOpen: (evidence: RiftTheorySuggestionEvidence) => void;
}) {
            ...
            {(evidence) => (
                <button
                    ...
                    onClick={(event: MouseEvent) => {
                        ...
                        props.onOpen(evidence());
                    }}
                >
                    <div
                        class="min-w-0 flex min-h-8 flex-wrap items-center gap-1 border-r border-neutral-800 pr-3"
                        title={t("colorPlan")}
                    >
                    ...
                    <div
                        class="min-w-0 flex min-h-8 flex-wrap items-center border-r border-neutral-800 pr-3"
                        title={t("roleEvidence")}
                    >
                        <span class="w-full text-[9px] uppercase tracking-wider text-neutral-500">
                            {t("roleEvidence")}
                        </span>
