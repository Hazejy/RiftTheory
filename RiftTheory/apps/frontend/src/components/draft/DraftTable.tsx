...
import { Icon, star, starOutline, informationCircle } from "../icons/RiftIcons";
...
export default function DraftTable() {
    ...
    const filteredSuggestions = () => {
        ...
        if (search()) {
            const str = normalizeChampionSearch(search());
            filtered = filtered.filter((s) => {
                const champion = dataset()!.championData[s.championKey];
                return (
                    normalizeChampionSearch(champion.name).includes(str) ||
                    normalizeChampionSearch(
    ...
    const [previewOriginal, setPreviewOriginal] = createSignal<{
        team: Team;
        index: number;
            ...
            if (pick.role !== undefined) {
                ...
                if (!previewOriginal()) {
                    ...
                    setPreviewOriginal({
                        ...
                        championKey: original.championKey,
                        role: original.role,
                    });
                }
    ...
    const columns: () => ColumnDef<Suggestion>[] = () => [
        ...
        },
        {
            ...
            meta: {
                headerClass: "w-60 min-w-52",
                cellClass: "w-60 min-w-52",
            },
        },
        {
            id: "draftFit",
            ...
            sortDescFirst: true,
            meta: {
                headerClass: "w-[34rem] min-w-[30rem]",
                cellClass: "w-[34rem] min-w-[30rem]",
            },
        },
        ...
        },
        {
            ...
            meta: { headerClass: "w-1", cellClass: "w-1" },
        },
    ];
