...
export const HISTORICAL_COLOR_BASELINES_PATH = resolve(
  CURATED_DATA_DIR,
  "historical_color_baselines.csv",
);
export const PROVISIONAL_COLOR_BASELINES_PATH = resolve(
  CURATED_DATA_DIR,
  "provisional_color_baselines.json",
);
